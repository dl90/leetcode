...
function random (n) {
  // 97 => a; 112 => z
  const rand = Math.floor(Math.random() * (112 - 97 + 1)) + 96
  return (n % 2) ? String.fromCharCode(rand).repeat(n) : String.fromCharCode(rand).repeat(n - 1) + String.fromCharCode(rand + 1)
}
